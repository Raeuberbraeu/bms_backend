...
import de.raeuberbraeu.bms.exception.UserNotFoundException;
import de.raeuberbraeu.bms.repository.UserRepository;
...
public class BackendController {
    ...
    public static final String HELLO_TEXT = "Hello from Spring Boot Backend! Eine Änderung";
